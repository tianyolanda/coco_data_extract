...
_IMAGE_PATH= '/home/ogai1234/datasets/coco/oo11/'
...
_ANNOTATION_SAVE_PATH= 'oo11_ano2'
# _IMAGE_CHANNEL= 3
...
def createChildNode(doc,tag, attr,parent_node): 
    ...
    # print('1111111111111',tag)
    # print('2222222222222',attr)
...
if __name__ == "__main__":
    ...
    n=0
    h=0
    img_path = "/home/ogai1234/datasets/coco/oo11/"
    fileList = os.listdir(img_path)
    if fileList == 0:
        os._exit(-1)

    with open("COCO_train_oo1.json", "r") as f:
